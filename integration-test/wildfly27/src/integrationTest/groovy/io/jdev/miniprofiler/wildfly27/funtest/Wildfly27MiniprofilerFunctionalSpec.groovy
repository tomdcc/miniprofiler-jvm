...
class Wildfly27MiniprofilerFunctionalSpec extends GebReportingSpec {
    ...
    void "can see miniprofiler"() {
        ...
        queries[1].query ==~ ~/select\s+p1_0\.id,\s*p1_0\.firstName,\s*p1_0\.lastName\s+from\s+Person\s+p1_0/
    }
}
