...
class WildflyContainerManager implements LauncherSessionListener {
    ...
    void launcherSessionOpened(LauncherSession session) {
        ...
        // Use WildFly 10.1.0.Final which requires Java 8 (matching our compiled bytecode).
        // WildFly 8.1.0.Final shipped with Java 7 which cannot load Java 8 class files.
        // WildFly 10 still provides the ExampleDS H2 datasource and supports Java EE 7.
